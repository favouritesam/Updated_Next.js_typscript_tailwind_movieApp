...
<div className="w-full h-screen bg-gray-900 text-white flex flex-col items-center justify-center mt-0 mb-0  mx-auto ">
<div className="bg-blue-500 py-4 px-4 md:px-0 w-screen mb-16">
